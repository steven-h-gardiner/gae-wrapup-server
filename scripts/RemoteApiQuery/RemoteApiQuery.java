 ...
 *
 * To run:
 * Compile with "javac -cp '.:appengine-api.jar:appengine-remote-api.jar'  RemoteApiQuery.java"
 * Run with "java -cp '.:appengine-api.jar:appengine-remote-api.jar'  RemoteApiQuery"
 *
 */
