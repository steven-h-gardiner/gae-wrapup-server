...
public class DeferredTaskContext {
 ...
 /**
   ...
   * the task will be retried, however if {@code setDoNotRetry}
   * is set to {@code true}, the task will not be retried.
   */
 ...
 /**
   ...
   * If an exception was thrown and {@link #setDoNotRetry} is set to {@code true}
