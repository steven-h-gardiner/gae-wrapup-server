...
public final class FacetRefinement {
  ...
  */
  private void checkValid() {
    ...
    Preconditions.checkArgument(getValue() != null || getRange() != null,
        String.format("Neither value nor range is set for FacetRefinement %s", getName()));
    Preconditions.checkArgument(getValue() == null || getRange() == null,
        String.format("Both value and range are set for FacetRefinement %s", getName()));
  }
