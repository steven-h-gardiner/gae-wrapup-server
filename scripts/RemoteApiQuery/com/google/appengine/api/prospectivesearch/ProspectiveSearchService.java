 ...
 *
 * @see <a href="http://cloud.google.com/appengine/docs/java/prospectivesearch/overview#Query_Language_Overview">Query
 * Language Overview</a> in the Developer Guide.
 * @see <a href="http://cloud.google.com/appengine/docs/java/prospectivesearch/overview#Handling_Matches">Handling
 * Matches</a> in the Developer Guide.
 *
...
public interface ProspectiveSearchService {
   ...
   * </pre>
   *
   * @see #match(Entity, String, String, String, String, int, boolean)
   */
   ...
   * @param resultTaskQueueName the name of the TaskQueue to use for
   ...
   * @throws IllegalArgumentException if no such subscription exists
