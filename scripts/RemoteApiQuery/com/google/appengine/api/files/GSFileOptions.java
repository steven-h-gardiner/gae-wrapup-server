 ...
 *
 * @see <a href="https://cloud.google.com/storage/docs/">Google Storage
 * API</a>.
 */
@Deprecated
public class GSFileOptions {
  ...
  public static class GSFileOptionsBuilder {
   ...
   /**
     ...
     * See <a href="https://cloud.google.com/storage/docs/reference-headers#contenttype">
     * Content-Type</a>.
     ...
     * See <a href="https://cloud.google.com/storage/docs/access-control">Access Control</a>.
     ...
     * See <a href="https://cloud.google.com/storage/docs/reference-headers#cachecontrol">
     * Cache-Control</a>.
     ...
     * See <a href="https://cloud.google.com/storage/docs/reference-headers#contentencoding">
     * Content-Encoding</a>.
     ...
     * See <a href="https://cloud.google.com/storage/docs/reference-headers#contentdisposition">
     ...
     * Each entry will be prefixed with <a
     * href="https://cloud.google.com/storage/docs/reference-headers#xgoogmeta">
     * x-goog-meta-</a> when serving out.
     * For example, if you add a {@literal 'foo'->'bar'} entry to userMetadata map,
