...
public interface QueryResultList<T> extends List<T> {
   ...
   *
   * @return a {@link Cursor} or {@code null} if this query result cannot be resumed. (Note that
   *     a Cursor is returned even if the end of the result list has been reached).
   */
  Cursor getCursor();
}
