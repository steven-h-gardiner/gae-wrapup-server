 ...
 * {@code limit}.<br>
 * <b>Note:</b> Using {@code offset} still retrieves skipped entities internally.
 * This affects the latency of the query, and <b>your application is billed for the
 * operations</b> required to retrieve them. Using cursors lets you avoid these costs.
 * <p>
 ...
 * import {@link FetchOptions} and invoke a static creation method followed by an instance mutator
 * (if needed):
 *
 * <pre>
