...
<![CDATA[
  ...
  <c:set var="referer">
   <jsp:expression>request.getHeader("referer")</jsp:expression>
  </c:set>
  <jsp:text>
    <html>
      <head>
	  ...
	  minutes.
        ...
        <ol>
          ...
          <li>
            ...
            <p>
              Please follow <a href="survey.html#hash=${hash}"
              _href="http://www.surveymonkey.com/s/VDD2VFS#hash=${hash}">this
